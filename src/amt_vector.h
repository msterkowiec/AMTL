...
namespace amt
{
	...
	class vector : public std::vector<__AMT_TRY_WRAP_TYPE__(T, PREVENT_AMT_WRAP, Alloc), __AMT_CHANGE_ALLOCATOR_IF_NEEDED__(T, PREVENT_AMT_WRAP, Alloc)>
	{
		...
		/*  * read
			...
			* write
			¯adne read'y nie konfliktowa³yby ze sob¹, wszystkie write'y konfliktwa³yby ze sob¹ nawzajem, a tak¿e z full read'em, a dodatkowo write knnfliktowa³by z wszystkim
        */
