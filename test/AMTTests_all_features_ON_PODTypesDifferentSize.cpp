...
// All AMTL  features on (macros overriden for sake of tests before inclusion of AMTL headers)
...
#define __AMT_FORCE_SAME_SIZE_FOR_TRIVIAL_TYPES__ 0

#define __AMT_TEST__ AMTLTest_AllFeatures_PODTypesDifferentSize
